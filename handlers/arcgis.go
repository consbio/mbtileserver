...
func (ts *Tileset) arcgisServiceHandler() handlerFunc {
	return func(w http.ResponseWriter, r *http.Request) (int, error) {
		...
		return http.StatusOK, wrapJSONP(w, r, svcJSON)
	}
}
...
func (ts *Tileset) arcgisLayersHandler() handlerFunc {
	return func(w http.ResponseWriter, r *http.Request) (int, error) {
		...
		return http.StatusOK, wrapJSONP(w, r, layersJSON)
	}
}
...
func (ts *Tileset) arcgisLegendHandler() handlerFunc {
	return func(w http.ResponseWriter, r *http.Request) (int, error) {
		...
		return http.StatusOK, wrapJSONP(w, r, legendJSON)
	}
}

func (ts *Tileset) arcgisTileHandler() handlerFunc {
	return func(w http.ResponseWriter, r *http.Request) (int, error) {
		db := ts.db
